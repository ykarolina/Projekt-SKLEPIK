...
<head>
    ...
    <link rel="stylesheet" href="../style/styl_glowna.css">
...
<body>
    ...
    <main class="main">
            <div class="row w-auto m-0">
                ...
                <div class="promocje col-12 col-md-7">
                    <h1>PROMOCJE!!!</h1>
                    <div class="promocjeProdukty d-flex flex-wrap justify-content-center">
                        <div class="promoProdukt">
                        <img src="../grafiki/bulki/bulka_golosza.png" alt="Promocja 1" class="imgPromo">
                        <p class="tekstPromo" style="margin-bottom: 0px;">Bulka Golosza</p>
                        <p style="font-size: 35px; margin: 0px;">6 zł</p>
                        <button class="btnPromo">Kup teraz</button>
                        </div>
                        <div class="promoProdukt" id="Promo2">
                            <img src="../grafiki/na_cieplo/hot_dog.jpg" alt="Promocja 1" class="imgPromo" style="height: 140px;">
                            <p class="tekstPromo" style="margin-bottom: 0px;">Hot dog</p>
                            <p style="font-size: 35px; margin: 0px;">5,50 zł</p>
                            <button class="btnPromo">Kup teraz</button>
                        </div>
                        <div class="promoProdukt" id="Promo3">
                            <img src="../grafiki/bulki/bulka_ser.png" alt="Promocja 1" class="imgPromo">
                            <p class="tekstPromo" style="margin-bottom: 0px;">Bulka Ser</p>
                ...
                <div class="godz_Otwarcia col-12 col-md-5">
                    <h2>GODZINY <br> OTWARCIA</h2>
                    <div class="pGodziny">
                        <p class="tekstGodziny">10.25 - 10.35</p>
                        <p class="tekstGodziny">11.20 - 11.30</p>
                        <p class="tekstGodziny">12.15 - 12.30</p>
                        <p class="tekstGodziny">13.15 - 13.25</p>
                        <p class="tekstGodziny">14.10 - 14.20</p>
                    </div>
                </div>
                
            </div>
            <div class="row w-auto m-0" >
                <div class="oferta col-12" id="ofertaNAV">
                    <h1 class="hTekst" id="oferta">NASZA OFERTA</h1>
                    <nav class="navOferta">
                        <div class="divOferta col w-100">
                            <a href="#kawaID" class="navHref">kawa</a>
                            <a href="#napojeID" class="navHref">napoje</a>
                            <a href="#bulkiID" class="navHref">bułki</a>
                            <a href="#na_cieploID" class="navHref">na ciepło</a>
                            <a href="#inneID" class="navHref">inne</a>
                        </div>
                    </nav>
                </div>
            </div>
